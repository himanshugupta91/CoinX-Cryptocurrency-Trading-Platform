...
public class CoinServiceImpl implements CoinService {
    ...
    @Override
    @org.springframework.cache.annotation.Cacheable(value = "coins", key = "#page")
    ...
    @Override
    @org.springframework.cache.annotation.Cacheable(value = "marketChart", key = "#coinId + '-' + #days")
    ...
    @Override
    @org.springframework.cache.annotation.Cacheable(value = "coinDetails", key = "#coinId")
